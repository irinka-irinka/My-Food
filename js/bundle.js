...
function forms(formSelector, modalTimerId) {
	...
	function bindPostData(form) {
		form.addEventListener("submit", e => {
			...
			( _services_services__WEBPACK_IMPORTED_MODULE_1__.postData)("http://localhost:3000/requests", json)
				.then(data => {
					console.log(data);
	...
	function showThankModal(message) {
		...
		(_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)(".modal", modalTimerId);
		...
		setTimeout(() => {
			...
			(_modal__WEBPACK_IMPORTED_MODULE_0__.closeModal)(".modal");
		}, 4000);
	}
}
...
window.addEventListener("DOMContentLoaded", function () {
	const modalTimerId = setTimeout(
		() => (_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)(".modal", modalTimerId),
		50000,
	);
	(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__.default)(
		".tabheader__item",
		".tabcontent",
		".tabheader__items",
		"tabheader__item_active",
	);
	(_modules_modal__WEBPACK_IMPORTED_MODULE_2__.default)("[data-modal]", ".modal", modalTimerId);
	(_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)(".timer", "2021-09-31");
	(_modules_cards__WEBPACK_IMPORTED_MODULE_4__.default)();
	(_modules_calc__WEBPACK_IMPORTED_MODULE_5__.default)();
	(_modules_forms__WEBPACK_IMPORTED_MODULE_6__.default)("form", modalTimerId);
	(_modules_slider__WEBPACK_IMPORTED_MODULE_7__.default)({
